...
namespace RandomNumberGenerators
{
    class Program
    {
        ...
        { 
            ...
            //programm kontrollib kas genereeritud number on väiksem kui 5
            //kui number on väiksem kui 5, siis konsool kuvab "juhuslik number on {MyRandomNumber}, see on väiksem kui 5"
            ...
            {
                Console.WriteLine($"juhuslik number on {MyRandomNumber}, see... ongi 5");
            }
        }
    }
}
